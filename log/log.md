...
- 2026-07-27: Added workflow constraint — even with LOCAL_FIRST=true, remote promotion must go through a pull request unless branch protection prevents it or the user explicitly overrides in the same turn (wiki/brain/constraints/remote-promotion-requires-pr.md).
- 2026-07-27: capture: User clarified workflow rule: even with LOCAL_FIRST=true, promoting local commits to remote must go through a pull reque
