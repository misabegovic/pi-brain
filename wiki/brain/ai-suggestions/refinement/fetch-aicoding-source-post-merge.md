...
`sources/web/2026-07-28--aicoding-leaflet-pub.md` is cited in the regenerative-intent epic as external evidence for spec-driven development, but its body says:
...
1. Try fetching `https://aicoding.leaflet.pub/` again with `/brain:connect` or a manual fetch.
2. If fetching still fails, manually summarize the page's argument and update the source file body.
