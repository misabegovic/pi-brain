...
- [Bet — Background task runner](wiki/brain/bets/background-task-runner.md)
...
- [Bet — `/brain:sync-code` reconciliation](wiki/brain/bets/brain-sync-code.md)
...
- [Bet — Multi-agent RFC collaboration](wiki/brain/bets/multi-agent-rfc-collaboration.md)
...
- [ADR — Background task runner](wiki/brain/adrs/background-task-runner.md)
...
- [ADR — `/brain:sync-code` reconciliation](wiki/brain/adrs/brain-sync-code.md)
...
- [ADR — Multi-agent intent collaboration for pi-brain](wiki/brain/adrs/multi-agent-intent-collaboration.md)
- [ADR — Multi-agent RFC collaboration](wiki/brain/adrs/multi-agent-rfc-collaboration.md)
...
### ai-suggestion
- [Add TypeScript as a dev dependency for strict checks](wiki/brain/ai-suggestions/refinement/add-typescript-dev-dependency.md)
...
- [Decide the fate of the demo RFC](wiki/brain/ai-suggestions/refinement/decide-demo-rfc-fate.md)
...
- [Formalize the PR-first workflow](wiki/brain/ai-suggestions/refinement/formalize-pr-first-workflow.md)
- [Merge PR #13](wiki/brain/ai-suggestions/refinement/merge-pr-13.md)
...
- [PRD — Background task runner](wiki/brain/prds/background-task-runner.md)
- [PRD — `/brain:diff` drift detection](wiki/brain/prds/brain-diff-drift-detection.md)
- [PRD — `/brain:sync-code` reconciliation](wiki/brain/prds/brain-sync-code.md)
...
- [PRD — Multi-agent RFC collaboration](wiki/brain/prds/multi-agent-rfc-collaboration.md)
...
### record
- [Record — Agent-maintained intent](wiki/brain/records/agent-maintained-intent.md)
- [Record — Autonomous colleague mode](wiki/brain/records/autonomous-colleague-mode.md)
- [Record — Autonomous refinement protocol](wiki/brain/records/autonomous-refinement-protocol.md)
- [Record — Background task runner](wiki/brain/records/background-task-runner.md)
- [Record — `/brain:diff` drift detection](wiki/brain/records/brain-diff-drift-detection.md)
- [Record — brain-state preserves custom content](wiki/brain/records/brain-state-preserves-custom-content.md)
- [Record — `/brain:sync-code` reconciliation](wiki/brain/records/brain-sync-code.md)
...
- [Record — Multi-agent intent collaboration](wiki/brain/records/multi-agent-intent-collaboration.md)
- [Record — Multi-agent RFC collaboration](wiki/brain/records/multi-agent-rfc-collaboration.md)
...
- [Record — Structured intent and `/brain:build`](wiki/brain/records/structured-intent-and-build.md)
...
- [Release](wiki/brain/records/version-0-3-2.md)

### rfc
- [RFC — Demo: Should pi-brain ship a default TUI theme?](wiki/brain/rfcs/demo-rfc.md)
